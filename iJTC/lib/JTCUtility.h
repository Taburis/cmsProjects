...
void JTCUtility::getJFF(TH2D* hrec, TH2D* hgen){
	...
	cout<<"p1 = "<<p1<<endl;
	fjff_deta = new TF1("jff_deta", "[0]+[1]*TMath::Exp(-x*x/2/[2])", -2.5, 2.5);
//	fjff_deta->SetParameter(0, p0);
	//fjff_deta->FixParameter(1, p1);
	fjff_deta->SetParameter(1, 40);
	//fjff_deta->SetParameter(1, p1);
//	fjff_deta->SetParameter(1, 100);
	fjff_deta->SetParameter(2, 0.1);
	hjff_deta->Fit(fjff_deta,"","", -1., 0.99);
	delete gen;
/*
